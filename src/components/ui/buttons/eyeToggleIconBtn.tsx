...
interface EyeToggleIconBtnProps {
	color?: string
	size?: number
	...
	return (
		...
		>
				...
				>
					...
					<g clipPath="url(#clip134_5126)">
						<path
							...
							stroke={getTailwindColor(color) || "#9C9C9C"}
			...
			{!show && !disabled && (
				...
				>
					<defs>
						<clipPath id="clip134_5175">
							<rect
								id="iconamoon:eyeOffLight"
								rx="0.000000"
								width={size}
								height={size}
								transform="translate(0.500000 0.500000)"
